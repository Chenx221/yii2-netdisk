    ...
    public static function detect($filePath): string
    {
        if (is_dir($filePath)) {
            ...
            return match ($extension) {
                ...
                'iso', 'img', 'mds', 'mdx', 'dmg', 'cdi', 'cue' => 'fa-solid fa-compact-disc',
                'vmdk', 'vhdx', 'vhd', 'vfd', 'vud', 'vdi', 'hdd', 'cow', 'qcow', 'qcow2', 'qed' => 'fa-regular fa-hard-drive',
                'db', 'frm', 'mdb', 'mdf', 'myd', 'myi', 'sqlite', 'sql' => 'fa-solid fa-database',
                ...
                'omf', 'ssh', 'pub', 'ppk', 'cer', 'crt', 'der', 'p7b', 'p7c', 'p12', 'pfx', 'pem' => 'fa-solid fa-key',
                'm3u', 'm3u8' => 'fa-regular fa-rectangle-list',
                'cnf', 'conf', 'cfg' => 'fa-solid fa-gears',
